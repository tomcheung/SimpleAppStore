// From https://github.com/kickstarter/Kickstarter-ReactiveExtensions/blob/master/ReactiveExtensions/test-helpers/TestObserver.swift
...
internal final class TestObserver <Value, Error: Swift.Error> {
	...
	internal var values: [Value] {
        return self.events.compactMap { $0.value }
	}
	...
	internal var failedError: Error? {
        return self.events.compactMap { $0.error }.first
	}
